...
class Coach(BaseCoach):
    ...
    def __init__(self, match):
        ...
        penalty_play = plays.cbfrs2022_5v5.PenaltyPlay(self)
        defend_penalty_play = plays.cbfrs2022_5v5.DefendPenaltyPlay(self)
        goalkick_play = plays.cbfrs2022_5v5.GoalKickPlay(self)
