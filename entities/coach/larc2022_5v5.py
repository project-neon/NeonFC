...
class Coach(BaseCoach):
    ...
    def __init__(self, match, coach_parameters={}):
        ...
        freeball_play = plays.larc2022_5v5.FreeballPlay(self)
        # def_freeball_play = plays.larc2022_5v5.DefFreeballPlay(self)
        ...
        # Contra bola parada da Bulls colocar outra play aqui
        ...
        main_play.add_transition(deffreeball_trigger, freeball_play)
        freeball_play.add_transition(freeball_seconds_trigger, main_play)
