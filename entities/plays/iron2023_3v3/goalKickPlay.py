...
class GoalKickPlay(MainPlay):
    def __init__(self, coach):
        ...
        self.constraints = [
            (strategy.larc2021.Shooter(self.match, "ShooterGoalkeeper"), self._elect_attacker),
            (strategy.iron2023_3v3.Midfielder(self.match), self._elect_goalkeeper),
            (strategy.iron2023_3v3.GoalKeeper(self.match, ""), self._elect_midfielder)
        ]
